...
export class QuoteComponent implements OnInit {
  ...
  quotes = [
    ...
    new Quote(3, 'Get new Phone Case', 'Diana has her birthday coming up soon', new Date(2020, 1, 12)),
    new Quote(4, 'Get Dog Food', 'Pupper likes expensive sancks', new Date(2021, 0, 18)),
    new Quote(5, 'Solve math homework', 'Damn Math', new Date(2023, 2, 14)),
...
addNewquote(quote){
  ...
  quote.PostedDate = new Date(quote.completedDate)
